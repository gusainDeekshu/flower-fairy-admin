      ...
      <div className="bg-white w-full max-w-xl rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in duration-200">
        ...
        >
          ...
          <input
            ...
            className="w-full p-2.5 border rounded-lg focus:ring-2 focus:ring-rose-500 outline-none"
          />
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              <select
                ...
                className="w-full p-2.5 border rounded-lg bg-white outline-none focus:ring-2 focus:ring-rose-500"
              >
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                step="0.01"
                placeholder="0.00"
                className="w-full p-2.5 border rounded-lg outline-none focus:ring-2 focus:ring-rose-500"
              />
            </div>
          </div>
            ...
            >
              {({ open }) => (
                <button
                  type="button"
                  onClick={() => open()}
                  className={`w-full flex flex-col items-center justify-center gap-2 p-6 border-2 border-dashed rounded-xl transition-all ${imageUrl ? "border-green-500 bg-green-50" : "border-zinc-300 hover:border-rose-500 bg-zinc-50"}`}
                >
                  {imageUrl ? (
                    <img
                      src={imageUrl}
                  ...
                  <span className="text-sm text-zinc-500 font-medium">
                    {imageUrl ? "Image Ready" : "Click to Upload"}
                  </span>
                </button>
              )}
            </CldUploadWidget>
          ...
          <button
            ...
            className="w-full bg-rose-500 text-white py-3 rounded-xl font-bold hover:bg-rose-600 disabled:bg-zinc-300 flex justify-center items-center gap-2 shadow-lg"
          >
            {mutation.isPending ? (
